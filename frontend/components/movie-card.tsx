...
export function MovieCard({ movie, subtitle, onSelect, selected, actionLabel, onAction, posterOnly = false }: MovieCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-3xl border text-left shadow-card outline-none transition focus-visible:border-sky-300/50 focus-visible:ring-2 focus-visible:ring-sky-300/30 ${
    ...
    >
      ...
      <div className="relative aspect-[2/3] w-full overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(3,7,18,0.02),transparent_58%,rgba(2,6,23,0.18)_100%)]" />
        {posterOnly ? (
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-black/55 to-transparent opacity-0 transition duration-300 group-hover:opacity-100" />
        ) : null}
      </div>
